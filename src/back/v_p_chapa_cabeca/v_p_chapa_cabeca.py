import pandas as pd
import numpy as np
from back.bolt_design import (solicitante_parafuso_tração, resistencia_parafuso_tração,
                                resistencia_parafuso_cisalhamento,solicitante_parafuso_momento,y_linha_neutra,solicitante_parafuso_cisalhamento)
